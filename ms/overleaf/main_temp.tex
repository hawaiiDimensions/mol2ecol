...
% * <linden.schneider@gmail.com> 2017-05-07T15:12:58.535Z:
% 
% how do you want to combine them?  I might add a 'through' after 'approches' to give readers a better idea of what you proposing in this paper. I know you specifiy in the following sentence, but maybe here you could say something like " high throughput ecology combined with robust statistical something"  I dont know!
% 
% 
% ^.
...
and from global to local spatial scales \citep{Sepkoski1984-kv, Alroy2010-lv,
% * <linden.schneider@gmail.com> 2017-05-07T15:38:16.416Z:
% 
% > scales
% not sure how else to say scales... but... you may want to chnage so the word are not repeating
% 
% 
% ^.
...
in][]{blonder2015}, although statistical and mechanistic approaches are not mutually
...
consistently tends toward a steady state determines how species
and communities will respond to imposed management strategies in addition to global environmental change
...
% * <linden.schneider@gmail.com> 2017-05-07T15:46:27.701Z:
% 
% > joint
% here i am not clear on what joint is refering to from the first half of the sentence to the part after the joint...
% 
% ^.
...
% * <linden.schneider@gmail.com> 2017-05-07T15:49:42.934Z:
% 
% maybe here you could have a nice concluding sentence saying: with these two new approches to data nd theory with will be able to addres issues XYandZ... I dont know, that might be my attachment to the 5 sentence paragraph talking haha
% 
% ^.
...
% * <linden.schneider@gmail.com> 2017-05-07T15:57:16.490Z:
% 
% not sure if you need more citations in this section... 
% 
% ^.
...
% * <linden.schneider@gmail.com> 2017-05-07T15:59:00.252Z:
% 
% > parameters
% not sure this is the correct word
% 
% ^.
...
% * <linden.schneider@gmail.com> 2017-05-07T15:59:34.571Z:
% 
% thats my love
% 
% 
...
% * <linden.schneider@gmail.com> 2017-05-07T16:04:45.460Z:
% 
% >  These handful of metrics may not
% > be sufficient to distinguish equilibrium from non-equilibrium
% why are they not sufficent? 
% 
% ^.
be sufficient to distinguish equilibrium from non-equilibrium
...
% * <linden.schneider@gmail.com> 2017-05-07T16:05:46.334Z:
% 
% yay!
% 
% ^.
...
% * <linden.schneider@gmail.com> 2017-05-07T16:12:18.579Z:
% 
% > Taking all of these elements of demographic history together
...
% 
% I feel like the paragraph is out of place ( maybe you could delete it!?) But maybe you need that Bayseain bit... not sure
% 
% ^.
(i.e. structure, divergence, expansion, size change and migration),
researcher, simulation-based coalescent approaches such as approximate
...
% * <linden.schneider@gmail.com> 2017-05-07T16:16:24.694Z:
% 
% > Indeed,
...
% > neutrality or selection \citep{Tajima1989-mc}.
% 
% I feel this could be deleted and the next sentence split in two and  reworked a bit to include a def of the Tajima D stat
% 
% ^.
one of the most commonly used techniques for detecting positive
selection relies on a summary statistic, Tajima's D, that can be
